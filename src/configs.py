...
def parse_config():
    ...
    parser.add_argument('--no_bottom_cameras', action='store_true', help='Two cameras added to paint the bottom surface')
    ...
    parser.add_argument('--input_image', type=str, default=None, help='Image reference')
